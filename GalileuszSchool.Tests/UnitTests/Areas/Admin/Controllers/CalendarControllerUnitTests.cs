...
//using GalileuszSchool.Controllers;
...
//        private readonly Mock<UserManager<AppUser>> _repoMock = new Mock<UserManager<AppUser>>();



//        public CalendarControllerUnitTests()
//        {
//            //var mockSet = new Mock<DbSet<Course>>();
//            //_contextMock.Setup(m => m.Courses).Returns(mockSet.Object);

//            _controller = new CalendarController(_contextMock.Object, _repoMock.Object);
//        }
//        [Fact]
...
//            };
//        }
//        private List<CalendarEvent> GetCalendarEventsList()
//        {
